...
##########################################################################################################
# Sets the typical compile options for a given target, besides the warnings which are set previously
...
##########################################################################################################
# There are two ways for a library to find its dependencies. They can be hardcoded in the library header
# or they can be relative paths the runtime linker should look for.
# More info here: https://gitlab.kitware.com/cmake/community/wikis/doc/cmake/RPATH-handling
# The following function allows to build relocatable libraries which do not encode the RPATH
