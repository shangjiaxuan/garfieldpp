...
bool MultipoleMoments(const unsigned int iw, const unsigned int order = 4,
  const bool print = false, const bool plot = false, const double rmult = 1.,
...
\begin{table}
  ...
  \begin{tabular}{l l} 
    ...
    \midrule
    Potential & \texttt{"v"}, \texttt{"p"} \\
    Magnitude of the field ($\left|\mathbf{E}\right|$) & \texttt{"e"}, \texttt{"field"} \\
