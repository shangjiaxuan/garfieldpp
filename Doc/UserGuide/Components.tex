...
\end{description}
neBEM subsequently determines the influence matrix $K$ and 
...
\subsection{Weighting fields}
In order to request neBEM to compute the weighting field of a 
given \texttt{Solid}, 
it is enough to give the \texttt{Solid} a label. 
\begin{lstlisting}
