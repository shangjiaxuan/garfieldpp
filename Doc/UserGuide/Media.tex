...
The fractions are number fractions (which are equivalent to volumetric fractions in an ideal gas).
...
The \texttt{\$GARFIELD\_INSTALL/share/Garfield/Data} directory includes a few files \\ 
