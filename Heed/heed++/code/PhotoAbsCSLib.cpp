...
ExAtomPhotoAbsCS Helium_PACS(2, shelllist_dir_name + "shelllist.dat",
                             pacs_table_dir_name + "He.dat");
ExAtomPhotoAbsCS Lithium_PACS(3, shelllist_dir_name + "shelllist.dat",
                              pacs_table_dir_name + "Li.dat");
ExAtomPhotoAbsCS Beryllium_PACS(4, shelllist_dir_name + "shelllist.dat",
                                pacs_table_dir_name + "Be.dat");
ExAtomPhotoAbsCS Boron_PACS(5, shelllist_dir_name + "shelllist.dat",
                            pacs_table_dir_name + "B.dat");
ExAtomPhotoAbsCS Carbon_PACS(6, shelllist_dir_name + "shelllist.dat",
...
//                                      "C_for_CH4",
//                                      12.65e-06);
ExAtomPhotoAbsCS Carbon_for_CH4_PACS(6, shelllist_dir_name + "shelllist.dat",
                                     shelllist_dir_name + "C_for_CH4.dat",
                                     "C_for_CH4", 12.65e-6);
ExAtomPhotoAbsCS Carbon_for_C2H4_PACS(6, shelllist_dir_name + "shelllist.dat",
                                      pacs_table_dir_name + "C.dat",
                                      "C_for_C2H4", 10.51e-06);
ExAtomPhotoAbsCS Carbon_for_C2H6_PACS(6, shelllist_dir_name + "shelllist.dat",
                                      pacs_table_dir_name + "C.dat",
                                      "C_for_C2H6", 11.52e-06);
ExAtomPhotoAbsCS Carbon_for_C4H10_PACS(6, shelllist_dir_name + "shelllist.dat",
                                       pacs_table_dir_name + "C.dat",
...
ExAtomPhotoAbsCS Carbon_for_CF4_PACS(6, shelllist_dir_name + "shelllist.dat",
                                     pacs_table_dir_name + "C.dat", "C_for_CF4",
                                     16.23e-06);
...
ExAtomPhotoAbsCS Nitrogen_PACS(7, shelllist_dir_name + "shelllist.dat",
                               ...
                               15.581e-6);
ExAtomPhotoAbsCS Oxygen_PACS(8, shelllist_dir_name + "shelllist.dat",
                             pacs_table_dir_name + "O.dat");
ExAtomPhotoAbsCS Oxygen_for_CO2_PACS(8, shelllist_dir_name + "shelllist.dat",
                                     pacs_table_dir_name + "O.dat", "O_for_CO2",
                                     13.79e-6);
ExAtomPhotoAbsCS Fluorine_PACS(9, shelllist_dir_name + "shelllist.dat",
                               pacs_table_dir_name + "F.dat");
ExAtomPhotoAbsCS Neon_PACS(10, shelllist_dir_name + "shelllist.dat",
                           pacs_table_dir_name + "Ne.dat");
ExAtomPhotoAbsCS Sodium_PACS(11, shelllist_dir_name + "shelllist.dat",
                             pacs_table_dir_name + "Na.dat");
ExAtomPhotoAbsCS Magnesium_PACS(12, shelllist_dir_name + "shelllist.dat",
                                pacs_table_dir_name + "Mg.dat");
ExAtomPhotoAbsCS Aluminium_PACS(13, shelllist_dir_name + "shelllist.dat",
                                pacs_table_dir_name + "Al.dat");
ExAtomPhotoAbsCS Silicon_PACS(14, shelllist_dir_name + "shelllist.dat",
                              pacs_table_dir_name + "Si.dat");
ExAtomPhotoAbsCS Silicon_crystal_PACS(14, shelllist_dir_name +
                                              "shelllist_solid.dat",
                                      pacs_table_dir_name + "Si.dat",
                                      "Si_crystal");
ExAtomPhotoAbsCS Silicon_G4_PACS(14, shelllist_dir_name + "shelllist_solid.dat",
                                 shelllist_dir_name + "Si_G4.dat", "Si_G4");
ExAtomPhotoAbsCS Phosphorus_PACS(15, shelllist_dir_name + "shelllist.dat",
                                 pacs_table_dir_name + "P.dat");
ExAtomPhotoAbsCS Sulfur_PACS(16, shelllist_dir_name + "shelllist.dat",
                             pacs_table_dir_name + "S.dat");
ExAtomPhotoAbsCS Chlorine_PACS(17, shelllist_dir_name + "shelllist.dat",
