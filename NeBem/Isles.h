...
ISLESGLOBAL int ExactRecSurf(double X, double Y, double Z,
																	double xlo, double zlo,
            											double xhi, double zhi,
																	double *Potential, Vector3D *Flux);

ISLESGLOBAL int ApproxRecSurf(double X, double Y, double Z,
																			double xlo, double zlo,
            													double xhi, double zhi,
																			int xseg, int zseg,
																			double *Potential, Vector3D *Flux);
...
ISLESGLOBAL double ApproxFX_W(double rW, double lW,
					double X, double Y, double Z, int zseg);

ISLESGLOBAL double ApproxFY_W(double rW, double lW,
					double X, double Y, double Z, int zseg);

ISLESGLOBAL double ApproxFZ_W(double rW, double lW,
					double X, double Y, double Z, int zseg);
...
ISLESGLOBAL double LineKnChPF(Point3D LineStart, Point3D LineStop,
														double radius, Point3D FieldPt, Vector3D *globalF);
