...
neBEMGLOBAL void GetPFGCS(int src, Point3D *localPt, double *Pot,
                          Vector3D *Flux, DirnCosn3D *DirCos);
neBEMGLOBAL void GetPF(int src, Point3D *localPt, double *Pot, Vector3D *Flux);
neBEMGLOBAL void RecPF(int src, Point3D *localPt, double *Pot, Vector3D *Flux);
neBEMGLOBAL void TriPF(int src, Point3D *localPt, double *Pot, Vector3D *Flux);
neBEMGLOBAL void WirePF(int src, Point3D *localPt, double *Pot, Vector3D *Flux);
